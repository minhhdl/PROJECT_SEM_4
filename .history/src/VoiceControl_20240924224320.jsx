  ...
  const handleVoiceCommand = (command) => {
    ...
    switch (command) {
      ...
      case "off the voice":
        ...
        setResponse("Turned off successfully");
        window.location.reload();
        break;
      case "manage":
  ...
  useEffect(() => {
    if (Cookies.get("isRead") === "false" || Cookies.get("isRead") == null) {
      if (location.pathname === "/") {
        setResponse(
          "Hello. You can read many types of books here. You can say the following words to change direction. 'Home' is to go to the home page. 'Books' is to go to the all books page. 'Blogs' is to go to the blogs page. 'Contact' is to go to the contact us page. 'Down' to scroll down the web page. 'Up' to scroll the web page up. 'Top' to scroll to the top of the web page. 'Bottom' to scroll to the bottom of the web page. 'Off the voice' to turn off the voice. 'Help me' to hear the instructions again"
        );
      }
