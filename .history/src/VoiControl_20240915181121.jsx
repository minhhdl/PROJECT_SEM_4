    ...
    if (response) {
      const voicesReady = () => {
        if (window.speechSynthesis.getVoices().length > 0) {
          speak(response); // Chỉ gọi speak khi các giọng nói đã được tải
          setResponse(""); // Đặt lại response sau khi đọc xong
        } else {
          // Đợi cho các giọng nói được tải xong rồi gọi lại
