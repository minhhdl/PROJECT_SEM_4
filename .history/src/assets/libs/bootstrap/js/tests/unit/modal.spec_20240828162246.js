...
describe("Modal", () => {
  ...
  describe("constructor", () => {
    it("should take care of element either passed as a CSS selector or DOM element", () => {
      fixtureEl.innerHTML =
        '<div className="modal"><div className="modal-dialog"></div></div>';
  ...
  describe("show", () => {
    ...
    it("should be shown after the first call to show() has been prevented while fading is enabled ", () => {
      return new Promise((resolve) => {
        fixtureEl.innerHTML =
          '<div className="modal fade"><div className="modal-dialog"></div></div>';
    ...
    it("should not overflow when clicking outside of modal-content if backdrop = static", () => {
      return new Promise((resolve) => {
        fixtureEl.innerHTML =
          '<div className="modal"><div className="modal-dialog" style="transition-duration: 20ms;"></div></div>';
    ...
    it("should not queue multiple callbacks when clicking outside of modal-content and backdrop = static", () => {
      return new Promise((resolve) => {
        fixtureEl.innerHTML =
          '<div className="modal"><div className="modal-dialog" style="transition-duration: 50ms;"></div></div>';
  ...
  describe("jQueryInterface", () => {
    ...
    it("should not call show method", () => {
      fixtureEl.innerHTML =
        '<div className="modal" data-bs-show="false"><div className="modal-dialog"></div></div>';
