              ...
              <button
                ...
                onKeyDown={(e) => {
                  if (e.key === " ") {
                    ...
                    // Thực hiện hành động phát âm thanh
                  }
                }}
                className="bg-red-500 ml-4 text-white p-3 rounded-full shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75"
              >
